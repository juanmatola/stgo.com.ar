<div class="row">
    <div class="col-md-6 col-12 text-start"><h1>Proyectos</h1></div>
    <div class="col-md-6 col-12 text-end my-2"><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addModal">+ Nuevo</button></div>
</div>
